...
# Motivation 
The _serosim_ package is designed to simulate serological survey data arising from 
...
Now, we specify the antibody model to be used within _runserosim_. We will be using 
