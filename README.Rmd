...
There are two additional vignettes/case studies in the _vignettes_ folder. 
Case study 1 provides an example of a longitudinal singular biomarker serological 
survey simulation structured around measles, a one-pathogen system with 
vaccination, but also applicable to other vaccine preventable diseases. Case 
study 2 provides an example of a cross-sectional multi-biomarker serological 
survey structured around diphtheria and pertussis, a two-pathogen system with 
