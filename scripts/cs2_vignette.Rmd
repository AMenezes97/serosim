...
Now, we need to specify the lambdas argument which contains the force of exposure
...
Since we have two groups, there are 2 rows in the first lambdas dimension.
```{r}
