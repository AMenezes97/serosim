...
plot_exposure_model(indivs=1:5,exposure_model, times, n_groups = 2, n_exposures = 3, foe_pars=foe_pars, demography=demography, dem_mod=dem_mod,t_in_year=t_in_year)
```
