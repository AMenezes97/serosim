...
vaccinated against measles or naturally infected, or a combination of both. We will set up each of the required arguments 
...
"reinfected" within the simulation.These "reinfection" events are representative 
...
## Plot titer dependent boosting effects given parameters specified within theta for antigen 1
...
We will take samples of all individuals alive at the midpoint and end of the 
