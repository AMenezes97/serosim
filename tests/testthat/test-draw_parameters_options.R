test_that("Check that draw_parameters_fixed_fx function works", {
  ...
  draw_pars_tmp<-draw_parameters_fixed_fx(1,1,1,1,example_demography, example_biomarker_states, example_model_pars_numeric)
...
test_that("Check that draw_parameters_random_fx function works", {
  ...
  expect_message(draw_parameters_random_fx(1,1,1,1,example_demography, example_biomarker_states, example_model_pars_numeric), regexp=NA)
})
...
test_that("Check that draw_parameters_fixed_fx_biomarker_dep function works", {
  ...
  draw_parameters_tmp<-draw_parameters_fixed_fx_biomarker_dep(2,100,1,1,example_demography, example_biomarker_states_wide, model_pars)
...
test_that("Check that draw_parameters_random_fx_biomarker_dep function works", {
  ...
  expect_message( draw_parameters_random_fx_biomarker_dep(2,100,1,1,example_demography, example_biomarker_states_wide, model_pars), regexp=NA)
})
