test_that("Check that observation_model_continuous function works", {
  ...
  ## Expect that observation_model_continuous function output equals 6.9365794
  expect_equal(obs_tmp$observed[6425], 6.9365794)
})
...
test_that("Check that observation_model_continuous_bounded function works", {
  ...
  ## Expect that observation_model_continuous_bounded function output equals 3.237098
  expect_equal(obs_tmp$observed[274], 3.237098)
})
...
test_that("Check that observation_model_continuous_bounded_noise function works", {
  ...
  expect_equal(obs_tmp$observed[24],2)
})
