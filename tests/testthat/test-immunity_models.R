...
test_that("Check that immunity_model_vacc_only function works if individual is eligible for vaccination", {
  ...
  expect_equal(immunity_model_vacc_only(1,8,1,tmp_immune_history,NULL, tmp_demography,NULL, NULL,max_vacc_events=2,vacc_age=5),1)
})
...
test_that("Check that immunity_model_vacc_only function works if indivdiual has already had the max number of vaccines", {
  ...
  ## Expect that the output of immunity_model_vacc_only function is 1
  expect_equal(immunity_model_vacc_only(1,8,1,tmp_immune_history,NULL, tmp_demography,NULL, NULL,max_vacc_events=1,vacc_age=5),0)
})
...
test_that("Check that immunity_model_vacc_only function works if individual is ineligible because they are too young", {
  ...
  ## Expect that the output of immunity_model_vacc_only function is 1
  expect_equal(immunity_model_vacc_only(1,3,1,tmp_immune_history,NULL, tmp_demography,NULL, NULL,max_vacc_events=2,vacc_age=5),0)
})
...
test_that("Check that immunity_model_vacc_ifxn_simple function works if individual is ineligible for vaccination exposure ", {
  ...
  expect_equal(immunity_model_vacc_ifxn_simple(1,8,1,tmp_immune_history,NULL, tmp_demography,NULL, NULL,max_events=c(3,5),vacc_exposures=c(1,2),vacc_age=c(1,1)),0)
})
...
test_that("Check that immunity_model_vacc_ifxn_simple function works if individual is eligible for vaccination exposure ", {
  ...
  ## Expect that the output of immunity_model_vacc_ifxn_simple function is 1
  expect_equal(immunity_model_vacc_ifxn_simple(1,8,2,tmp_immune_history,NULL, tmp_demography,NULL, NULL,max_events=c(3,5),vacc_exposures=c(1,2),vacc_age=c(1,1)),1)
})
...
test_that("Check that immunity_model_vacc_ifxn_simple function works if individual is ineligible for natural infection exposure ", {
  ...
  expect_equal(immunity_model_vacc_ifxn_simple(1,8,1,tmp_immune_history,NULL, tmp_demography,NULL, NULL,max_events=c(3,5),vacc_exposures=2,vacc_age=c(1,1)),0)
})
...
test_that("Check that immunity_model_vacc_ifxn_simple function works if individual is eligible for natural infection exposure ", {
  ...
  ## Expect that the output of immunity_model_vacc_ifxn_simple function is 1
  expect_equal(immunity_model_vacc_ifxn_simple(1,8,1,tmp_immune_history,NULL, tmp_demography,NULL, NULL,max_events=c(4,5),vacc_exposures=2,vacc_age=c(1,1)),1)
})
...
test_that("Check that immunity_model_ifxn_biomarker_prot function works", {
  ...
  max_events<-c(Inf,Inf)
  
  ## Expect that the output of immunity_model_ifxn_biomarker_prot function is 0.4273919
  expect_equal(immunity_model_ifxn_biomarker_prot(1,8,1,immune_histories=tmp_immune_history, biomarker_states=tmp_biomarker_states, demography=NULL, biomarker_map=example_biomarker_map_numeric, model_pars=tmp_pars, max_events=max_events),0.42739194)
})
...
test_that("Check that immunity_model_vacc_ifxn_biomarker_prot function works for eligible vaccination exposures", {
  ...
  expect_equal(immunity_model_vacc_ifxn_biomarker_prot(1,8,1,immune_histories=tmp_immune_history, biomarker_states=tmp_biomarker_states, demography=tmp_demography, 
...
test_that("Check that immunity_model_vacc_ifxn_biomarker_prot function works for ineligible vaccination exposures", {
  ...
  expect_equal(immunity_model_vacc_ifxn_biomarker_prot(1,8,1,immune_histories=tmp_immune_history, biomarker_states=tmp_biomarker_states, demography=tmp_demography, biomarker_map=example_biomarker_map_numeric, 
...
test_that("Check that immunity_model_vacc_ifxn_biomarker_prot function works for eligible natural infection exposures", {
  ...
  expect_equal(immunity_model_vacc_ifxn_biomarker_prot(1,8,2,immune_histories=tmp_immune_history, biomarker_states=tmp_biomarker_states, demography=tmp_demography, biomarker_map=example_biomarker_map_numeric, model_pars=tmp_pars,max_events=c(3,10),vacc_exposures=1,vacc_age=1), 0.9999039)
})
...
test_that("Check that immunity_model_vacc_ifxn_biomarker_prot function works for ineligible natural infection exposures", {
  ...
  ## Expect that the output of immunity_model_vacc_ifxn_biomarker_prot function is 0
  expect_equal(immunity_model_vacc_ifxn_biomarker_prot(1,8,2,immune_histories=tmp_immune_history, biomarker_states=tmp_biomarker_states, demography=tmp_demography, 
